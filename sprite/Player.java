...
public class Player extends Sprite {
	 ...
	 public Player(Pane layer, Image image, double x, double y, double r, double dx, double dy, double dr, double health, double damage, double speed, Input input, double ox, double oy) {
